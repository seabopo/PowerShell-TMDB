#
# Module manifest for module 'po.TMDB'
#
# Generated by: Sean Powell (seabopo)
#
# Generated on: 8/17/2025
#
...
GUID = '0de4ef0a-0959-4883-b699-0aec57f00ac0'
...
FunctionsToExport = @('Get-TMdbContentRatings','Get-TMdbCredits','Get-TMdbImages','Get-TMdbExternalIDs',
                      'Get-TMdbGenres','Find-TMdb','Get-TMdbMovie',
...
AliasesToExport = @('Get-TMdbTVShow')
